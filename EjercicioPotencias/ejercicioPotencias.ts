...
//Siempre hay que poner el tipo de la variable que la funcion retorna. void si no retorna nada
function buscarPotencia(base:number, exponente:number): number{
